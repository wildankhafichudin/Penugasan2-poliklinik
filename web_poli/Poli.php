...
<body>
    ...
    <div class="main-content">
        ...
        <div class="cards-container">
            <div class="card">
                <h2>Tambah Poli</h2>
                <p>Tambahkan Poli Baru.</p>
                <a href="Daftar-Poli.php">Tambah Poli</a>
            </div>
            <div class="card">
                <h2>Edit Poli</h2>
                <p>Perbarui Informasi Poli.</p>
                <a href="DataEdit-Poli.php">Edit Data Poli</a>
            </div>
        </div>
    </div>
</body>
