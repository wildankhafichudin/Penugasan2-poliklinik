...
<body>
  ...
  <div class="login-container">
    <form name="loginForm" onsubmit="return validateForm()" action="ConfigLGN-Pasien.php" method="POST">
      <input type="text" name="nama" placeholder="Nama Lengkap" required>
        <div style="position: relative; width: 82%; margin-bottom: 10px;">
          <input type="password" name="passwordPasien" placeholder="Password" id="passwordField" style="width: 100%; padding-right: 40px;" required>
          <span onclick="togglePassword()" style="position: absolute; top: 50%; transform: translateY(-65%); cursor: pointer; left: 350px;">
