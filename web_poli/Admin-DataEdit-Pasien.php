...
<body>
    ...
    <div class="main-content">
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    ...
                    $sql = "SELECT id, nama, alamat, no_ktp, no_hp, passwordPasien, no_rm FROM pasien";
                    $result = $conn->query($sql);

                    if ($result->num_rows > 0) {
                        // Output data setiap baris
                        while($row = $result->fetch_assoc()) {
                            echo "<tr onclick=\"populateForm('".$row['id']."', '".$row['nama']."', '".$row['alamat']."', '".$row['no_ktp']."', '".$row['no_hp']."', '".$row['passwordPasien']."', '".$row['no_rm']."')\">
                                    <td>".$row["id"]."</td>
                                    <td>".$row["nama"]."</td>
                                    <td>".$row["alamat"]."</td>
                                    <td>".$row["no_ktp"]."</td>
                                    <td>".$row["no_hp"]."</td>
                                    <td>".$row["passwordPasien"]."</td>
                                    <td>".$row["no_rm"]."</td>
                                  </tr>";
                        }
                    } else {
        ...
        <div class="form-container">
            <form action="EDTPasien.php" method="POST">
